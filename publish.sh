...
echo "ssh -p xxx -tt -o StrictHostKeyChecking=no xxx@174.137.56.192 sh $version"
ssh -p 924 -tt -o StrictHostKeyChecking=no lmm@ras0.com /home/lmm/projects/api/publish.sh $version
