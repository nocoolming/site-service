...
echo "ssh -p 19849 -tt -o StrictHostKeyChecking=no root@174.137.56.192 /root/projects/api/publish.sh $version"
ssh -p 924 -tt -o StrictHostKeyChecking=no root@ras0.com /root/projects/api/publish.sh $version
